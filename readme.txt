...
- search games by title, genre, developer

Admin information to login: admin@admin.com - password 1234Admin!

Admins can:
-add,edit,delete records and upload cover images for games